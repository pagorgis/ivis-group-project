...
function StackedBar(inputId) {
    ...
    var rest=(tearcherData.kontering-tearcherData.gru_ht-tearcherData.gru_vt-tearcherData.self_dev).toFixed(2);
...
tooltip
  .style("left", (mouse(this)[0])+700 + "px") 
  .style("top", (mouse(this)[1])+250 + "px")
}
