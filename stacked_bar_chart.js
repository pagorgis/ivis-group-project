...
// Parse the Data
//d3.csv("https://raw.githubusercontent.com/Mangobiubiu/data/master/staff.csv", function(data) {

// List of subgroups = header of the csv files = soil condition here
//})
window.onload = function () {
  var data;
  var url = "course.json"/*json文件url，本地的就写本地的位置，如果是服务器的就写服务器的路径*/
    ...
    .enter().append("g")
      ...
      .enter().append("rect")
        ...
        .on("mouseover", function(d) {
          tooltip
           .html(" name: " +d.name+"<br/>"+" type: "+d.type+"<br/>"+" hour： "+d.hours+"<br/>")
